/*
 * Modified for ECO-C.
 * To use short ints and inline, define FAST.
 * 09-10-1993 sv@mct
 */ 
/*
 ****************************************************************************
...
#define CLOCK /* use ANSI clock function */
...
/* This definition permits usage of library string-functions sv@. */
#if defined MYSTRFUNC  
...
#define TIME    (times(&time_info), time_info.tms_utime)     
#define HZ 1000000
#endif
...
//  puts("Finish");
  ...
  User_Time = (End_Time - Begin_Time); // /CLOCKS_PER_SEC;
  ...
  else
  {
    ...
    Microseconds = 1000000 / Dhrystones_Per_Second;
